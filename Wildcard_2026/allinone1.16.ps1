...
# Splunk Agent
#--------------------------------------------------------------
funtation agentsetup-splunk {
$serviceExists = Get-Service -Name "splunk" -ErrorAction SilentlyContinue
if ($serviceExists) {
    Write-Output "Splunk is installed."
    Write-Output "Reinstalling splunk now."

} else {
    Write-Output "Service is NOT installed."
    Write-Output "Installing splunk now."
    param (
