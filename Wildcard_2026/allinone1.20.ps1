...
$Password = Read-Host -AsSecureString -Prompt "Enter the Password for the Backup Account"

# $username get the username from a user input
$username = Read-Host -AsSecureString -Prompt "Enter the Username for the Backup Account"

# $FullName get the Full name from a user input
$FullName = Read-Host -AsSecureString -Prompt "Enter the Full Name for the Backup Account"

# $Description get the description from a user input
$Description = Read-Host -AsSecureString -Prompt "Enter the description for the Backup Account"
