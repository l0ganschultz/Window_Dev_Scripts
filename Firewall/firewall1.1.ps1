...
New-NetFirewallRule -DisplayName "FTP Website Inbound Port 443" -Direction Inbound -LocalPort 443 -Protocol TCP  -Action Allow

New-NetFirewallRule -DisplayName "FTP Website Outbound Port 443" -Direction Outbound -LocalPort 443 -Protocol TCP  -Action Allow

New-NetFirewallRule -DisplayName "FTP Website Inbound Port 80" -Direction Inbound -LocalPort 80 -Protocol TCP  -Action Allow

New-NetFirewallRule -DisplayName "FTP Website Outbound Port 80" -Direction Outbound -LocalPort 80 -Protocol TCP  -Action Allow

New-NetFirewallRule -DisplayName "FTP Control Port Inbound Port 21" -Direction Inbound -LocalPort 21 -Protocol TCP  -Action Allow

New-NetFirewallRule -DisplayName "FTP Control Port Outbound Port 21" -Direction Outbound -LocalPort 21 -Protocol TCP  -Action Allow

New-NetFirewallRule -DisplayName "FTP Data Port Inbound Port 20" -Direction Inbound -LocalPort 20 -Protocol TCP  -Action Allow

New-NetFirewallRule -DisplayName "FTP Data Port Outbound Port 20" -Direction Outbound -LocalPort 20 -Protocol TCP  -Action Allow
